...
// Gently brand-tuned Material palette — was teal/green by default
const MD_C = {
  surface: '#F2F4F7',
  surfaceVariant: '#DDE3EB',
  inverseOnSurface: '#E9EDF2',
  secondaryContainer: '#D6ECF6',
  primaryFixedDim: '#5DCBED',
  onSurface: '#0C141C',
  onSurfaceVar: '#4E5A68',
  onPrimaryContainer: '#062533',
  primary: '#0E8FB6',
  frameBorder: 'rgba(110,120,132,0.5)',
};
